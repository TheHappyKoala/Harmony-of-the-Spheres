      ...
      <div className={control}>
        ...
        <div className={controlInput}>
          <Slider
            ...
            onChange={(event) => onOrbitalElementsChangeCallback(event, "a")}
          />
        </div>
      </div>
      <div className={control}>
        ...
        <div className={controlInput}>
          <Slider
            ...
            onChange={(event) => onOrbitalElementsChangeCallback(event, "e")}
          />
        </div>
      </div>
      <div className={control}>
        ...
        <div className={controlInput}>
          <Slider
            ...
            onChange={(event) => onOrbitalElementsChangeCallback(event, "i")}
          />
        </div>
      </div>
      <div className={control}>
        ...
        <div className={controlInput}>
          <Slider
            ...
            onChange={(event) => onOrbitalElementsChangeCallback(event, "lAn")}
          />
        </div>
      </div>
      <div className={control}>
        ...
        <div className={controlInput}>
          <Slider
            ...
            onChange={(event) => onOrbitalElementsChangeCallback(event, "argP")}
          />
        </div>
      </div>
      <div className={control}>
