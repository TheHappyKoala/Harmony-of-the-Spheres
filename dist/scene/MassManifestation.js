...
export default class extends THREE.Object3D {
    ...
    getMain() {
        const geometry = new THREE.SphereBufferGeometry(this.mass.radius, this.mass.type !== 'asteroid' ? this.segments : 6, this.mass.type !== 'asteroid' ? this.segments : 6);
        const material = new THREE.MeshPhongMaterial({
            map: this.textureLoader.load(this.mass.type === 'asteroid'
                ? './textures/Deimos.jpg'
                : `./textures/${this.mass.texture}.jpg`),
            bumpMap: this.mass.bump === true
    ...
    getAtmosphere() {
        const geometry = new THREE.SphereBufferGeometry(this.mass.radius + this.mass.radius / 15, this.segments, this.segments);
    ...
    getClouds() {
        const geometry = new THREE.SphereBufferGeometry(this.mass.radius + this.mass.radius / 80, this.segments, this.segments);
    ...
    draw(x, y, z, cameraPositionVector, distanceToCamera) {
        ...
        if (this.mass.atmosphere) {
            ...
            atmosphere.material.uniforms.viewVector.value = new THREE.Vector3().subVectors(cameraPositionVector, { x, y, z });
...
//# sourceMappingURL=MassManifestation.js.map