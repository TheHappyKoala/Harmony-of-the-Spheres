...
export default class extends MassManifestation {
    ...
    getMain() {
        ...
        if (this.mass.spacecraft)
            container.rotateX(degreesToRadians(90));
        this.add(container);
        const massNameLowerCase = this.mass.texture.toLowerCase();
        const loader = new ColladaLoader();
        loader.load(`./models/${massNameLowerCase}/${massNameLowerCase}.dae`, collada => {
            collada.scene.scale.set(this.mass.radius, this.mass.radius, this.mass.radius);
