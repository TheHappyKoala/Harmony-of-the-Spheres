...
export default class extends Euler {
    constructor({ g, dt, masses, elapsedTime }) {
        ...
        this.lastAcc = this.generateAccelerationVectors(this.getStateVectors(this.masses).p);
    }
    generateVerletPositionVectors(s, a, dt) {
        const p = [];
        const aLen = a.length;
        for (let i = 0; i < aLen; i++) {
            ...
            p[i] = this.p
                ...
                .addScaledVector(0.5, this.utilityVector.set(aI).multiplyByScalar(Math.pow(dt, 2)))
                .toObject();
        }
        return p;
    }
    generateVerletVelocityVectors(a1, a2, dt) {
        const v = [];
        ...
        for (let i = 0; i < aLen; i++) {
            ...
            v[i] = this.v
                ...
                .addScaledVector(0.5, this.utilityVector
                .set(aI1)
                .add(aI2)
                .multiplyByScalar(dt))
                .toObject();
...
//# sourceMappingURL=Verlet.js.map