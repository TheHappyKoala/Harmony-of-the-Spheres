...
export function getOrbit(primary, secondary, g) {
    ...
    const secondaryV = new H3()
        ...
        .rotate({ x: 0, y: 0, z: 1 }, secondary.w)
        .rotate({ x: 0, y: 1, z: 0 }, secondary.i);
    return Object.assign({}, secondary, { x: x + secondaryP.x, y: y + secondaryP.y, z: z + secondaryP.z, vx: vx + secondaryV.x, vy: vy + secondaryV.y, vz: vz + secondaryV.z });
}
...
export function elementsToVectors(primary, masses, g) {
    const primaryWithVectors = Object.assign({}, primary, { x: 0, y: 0, z: 0, vx: 0, vy: 0, vz: 0 });
