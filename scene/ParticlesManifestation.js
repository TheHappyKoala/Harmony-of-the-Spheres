import { Object3D, Color, BufferGeometry, BufferAttribute, Points } from 'three';
import particleMaterial from './particleMaterial';
import { getRandomNumberInRange } from '../Physics/utils';
export default class extends Object3D {
    constructor({ particles, scenarioScale, size, max, type, hsl, twinklingParticles }) {
        super();
    ...
    getParticles() {
        ...
        const material = particleMaterial(this.type === 'Galaxy' ? false : true, 'cloud');
...
//# sourceMappingURL=ParticlesManifestation.js.map